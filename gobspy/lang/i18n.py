...
# boards
    ...
    'Cannot move':
      'No se puede mover el cabezal. La posición cae afuera del tablero',
    'Cannot move to %s':
      'No se puede mover el cabezal en dirección: %s. La posición cae afuera del tablero',
    'Invalid direction':
      'Dirección inválida',
...
# Exception interpretation
    "Error interpretation": "Interpretación del error",

    "name '{}' is not defined": "El identificador '{}' no existe. Quizás escribiste mal el nombre",
    "Cannot move to {}": "No se puede mover el cabezal al {}. La posición cae afuera del tablero",
    "unexpected indentation": "El código está mal indentado. Fijate que coincidan la cantidad de espacios/tabs que usaste para indentar",
    "invalid syntax": "La sintaxis que usaste está mal. Fijate si usaste algún caracter raro.",


# Solutions
    'to_fix_this_error' : '¿Qué hacer para arreglar este error?',

    'check_variable_defined' : 'Si es una variable, fijate si le diste valor al identificador antes de utilizarlo',
    'check_main_def': "Si se trata del procedimiento 'Main', fijate si escribiste con mayúscula la definición",
    'check_value_name': "Si es un valor de Gobstones, como 'Rojo' o 'Norte', fijate si escribiste la primera letra sin mayuscula",
    'check_strange_character' : "Si hay un caracter raro, borralo o corregilo. Por ejemplo, letras con tilde o la 'ñ' no son válidas.",
    'check_syntax' : 'Fijate si en esa línea hay algun caracter raro o alguna escritura que no forma parte del lenguaje',
    'check_identifier_name' : 'Si se trata de un parámetro, índice, nombre de procedimiento o nombre de función, verificá que el nombre está bien escrito de acuerdo a cómo lo definiste anteriormente',
    'check_indent': 'Fijate que coincida la indentación que utilizaste con la línea anterior, es decir, que tengan la misma cantidad de espacios/tabs',
    'find_error_position'   : 'Buscá dentro del error la línea de código y la posición donde ocurre el error',

    'check_move': 'Observá cómo utilizás el comando Mover. Quizá le pasaste una dirección equivocada',
    'check_command_order': 'Verificá que el orden de los comandos es el correcto',
    'check_precondition': '¿Estás queriendo ejecutar un procedimiento o función sin asegurarte de que su precondición se cumple?',
    'check_repetition': 'Si estás utilizando repetición indexada o repetición condicional, entendé bien qué estás haciendo y asegurante que el cabezal pueda continuar moviendose en esa dirección mientras dure la repetición'
}
...
t = lambda s: translate(s)

Token_type_descriptions = {
    'EOF': translate('end of input'),
    'BOF': translate('beggining of input'),
    'num': translate('a number'),
    'string': translate('a string'),
    'lowerid': translate('a lowercase identifier'),
    'upperid': translate('an uppercase identifier'),
}

AST_type_descriptions = {
    'function': translate('function definition'),
    'procedure': translate('procedure definition'),
    'procCall': translate('procedure call'),
    'assignVarName': translate('variable assignment'),
    'varName': translate('variable name'),
    'funcCall': translate('function call'),
    'and': translate('logical operator'),
    'or': translate('logical operator'),
    'not': translate('logical operator'),
    'relop': translate('relational operator'),
    'listop': translate('list operator'),
    'addsub': translate('arithmetic operator'),
    'mul': translate('arithmetic operator'),
    'pow': translate('arithmetic operator'),
    'divmod': translate('arithmetic operator'),
    'unaryMinus': translate('arithmetic operator'),
    'import': translate('import clause'),
}
